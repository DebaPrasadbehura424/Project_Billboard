...
export default function NavBar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b bg-[#0A0A0A]/95 backdrop-blur-xl">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-2">
            <Shield className="h-8 w-8" style={{ color: "#FAFAFA" }} />
        ...
        <div
          className={`${
            isOpen ? "block" : "hidden"
          } md:hidden bg-[#0a0a0a] border-t border-gray-700`}
        >
