...
import roadsideBillBoard from "../images/roadside-billboard.png";
import billboardplacement from "../images/billboard-placement.png";

function Home() {
  return (
    <div className="space-y-20 bg-[#0A0A0A] font-sans text-[#FAFAFA]">
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        <div className="text-center space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight">
              Keep Your City <span className="text-[#FAFAFA]">Compliant</span>
            </h1>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-7xl sm:text-4xl font-bold">How It Works</h2>
          <p className="text-2xl text-[#FAFAFA] max-w-2xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <Shield className="h-6 w-6 text-[#FAFAFA] mt-1" />
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <Eye className="h-6 w-6 text-[#FAFAFA] mt-1" />
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <Users className="h-6 w-6 text-[#FAFAFA] mt-1" />
                  <div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center space-y-8">
          ...
          <p className="text-xl text-[#FAFAFA] max-w-2xl mx-auto">
